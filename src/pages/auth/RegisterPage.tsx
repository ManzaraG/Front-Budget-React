...
import { RegisterFormComponent } from '@/features/auth/register'
        ...
        <div className="flex min-h-screen w-full bg-white">
            ...
            <div className="relative hidden w-1/2 items-center justify-center overflow-hidden bg-linear-to-br from-blue-500 via-blue-600 to-blue-800 p-12 text-white lg:flex">
                ...
                <div className="relative z-10 max-w-sm space-y-4">
                    <p className="text-white/80">Bienvenue</p>
                    <h1 className="text-4xl leading-tight font-extrabold">REJOIGNEZ-NOUS</h1>
                    <div className="h-1 w-14 rounded-full bg-white/80" />
                    <p className="leading-relaxed text-white/70">
                        Créez votre compte pour suivre vos dépenses, gérer votre budget et garder le
                        contrôle de vos finances personnelles, où que vous soyez.
                    </p>
                </div>
            </div>
